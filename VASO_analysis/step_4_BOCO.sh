...
# Run P04: NORDIC[vaso_analysis/magn_phase--/vaso_analysis/magn_only]--REF.[/vaso_analysis/standard]
# Run P03: NORDIC[vaso_analysis/magn_phase--/vaso_analysis/magn_only]--REF.[/vaso_analysis/standard] & magn_phasenoNOISE,magn_only_noNOISE
...
cd ${mywork}
# Nulled and NotNulled separation (half n. vols) and upsampling (back to the orig. n. vols)
