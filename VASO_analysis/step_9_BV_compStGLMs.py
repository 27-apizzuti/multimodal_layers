...
GLM-Axis of Motion Pilot
    ...
    BOLD and VASO respectivly (BOCO-s ouput) for one or some of the following conditions:

        1. Standard (no NORDIC)
        2. NORDIC: magnitude only
        3. NORDIC: magnitude and phase *(except for P02)

PS: Remember NORDIC is run as 1rst step on the intervealed time course (no 'BOLD' and 'VASO' time series separation)
    VTC are already masked outside BrainVoyager
...
# =============================================================================
# .fmr input path (already created)
