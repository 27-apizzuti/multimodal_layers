...
CONDT = ['standard']
ROI_NAME = ['rightMT_Sphere16radius']      # , 'rightMT_Sphere16radius'

MAPS_NAME = ['_BOLD_rightMT_Sphere16radius_tmaps.nii.gz',
             '_rightMT_Sphere16radius.nii.gz', '_VASO_rightMT_Sphere16radius_tmaps.nii.gz']
