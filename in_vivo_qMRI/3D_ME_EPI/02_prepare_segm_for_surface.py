"""Read RIM Nifti write BrainVoyager VMR WM segmentation file"""
import os
import bvbabel
...
FILE = "/mnt/d/AHEAD_v2/derivatives/demo_whole_brain/seg-01_LH_rim.nii.gz"
...
nii_data[nii_data == 2] = 240
nii_data[nii_data < 240] = 0
